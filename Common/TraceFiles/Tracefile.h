...
public:
	...
	/** \brief Standardformatierer f黵 einen Parameter
	 *
	 * Dieser Funktor erzeugt eine String-Darstellung des Parameters in folgender
	 * Formatierung: [IN ]|[OUT]  <name>: <wert>
	 * F黵 die Ermittlung der Darstellung des Wertes des Objekts kann ein
	...
	/** \brief Standardformatierer f黵 einen Wert.
	 *
	 * Dieser Funktor erzeugt eine String-Darstellung eines Objekts, indem es es
	 * in einen basic_ostringstream einf黦t. Er kann f黵 alle einfachen Datentypen
	 * verwendet werden.
	 */
 ...
 *
 * Diese Klasse repr鋝entiert formatiert darstellbare Parameter, die in 
 * ENTER- oder LEAVE-Eintr鋑en im Log ausgegeben werden k鰊nen. Die

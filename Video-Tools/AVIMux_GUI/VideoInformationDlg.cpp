...
// Hinweis: Wir stellen Unterst黷zung f黵 IID_IVideoInformationDlg zur Verf黦ung, um typsicheres Binden
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f黵 Nachrichten CVideoInformationDlg 
...
// suggested buffer size
	...
	for (i=0;i<=(int)avifile->GetNbrOfStreams();i++)
	{
		...
		// Bitrate
			...
			{
			// nicht (MP3-VBR) => Anzahl an dwSamplesize-gro遝r Bl鯿ke

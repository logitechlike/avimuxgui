...
bool EBMLM_TRTrackEntry::CheckIDs(char* iID,EBMLElement** p)
{
  ...
  DOCOMP(MID_TR_ADDITION_MAPPING, EBMLM_TRBlockAdditionMapping)
...
DEF_MATR_CLASS(EBMLM_TRBlockAdditionMapping,ETM_TR_ADDITION_MAPPING, false, true, "BlockAdditionMapping");
...
bool EBMLM_TRBlockAdditionMapping::CheckIDs(char* iID, EBMLElement** p)
{
  DOCOMP(MID_TR_ADDITION_MAPPING_ID, EBMLM_TRBlockAdditionMapping_ID)
  DOCOMP(MID_TR_ADDITION_MAPPING_IDName, EBMLM_TRBlockAdditionMapping_IDName)
  DOCOMP(MID_TR_ADDITION_MAPPING_IDType, EBMLM_TRBlockAdditionMapping_IDType)
  DOCOMPL(MID_TR_ADDITION_MAPPING_IDExtraData, EBMLM_TRBlockAdditionMapping_IDExtraData)
}
DEF_MATR_CLASS(EBMLM_TRBlockAdditionMapping_ID, IDVALUE(MID_TR_ADDITION_MAPPING_ID), false, EBMLDATATYPE_ASCII, "MAPPING_ID");
DEF_MATR_CLASS(EBMLM_TRBlockAdditionMapping_IDName, IDVALUE(MID_TR_ADDITION_MAPPING_IDName), false, EBMLDATATYPE_ASCII, "MAPPING_IDName");
DEF_MATR_CLASS(EBMLM_TRBlockAdditionMapping_IDType, IDVALUE(MID_TR_ADDITION_MAPPING_IDType), false, EBMLDATATYPE_ASCII, "MAPPING_IDType");
DEF_MATR_CLASS(EBMLM_TRBlockAdditionMapping_IDExtraData, IDVALUE(MID_TR_ADDITION_MAPPING_IDExtraData), false, EBMLDATATYPE_BIN, "MAPPING_IDExtraData");
